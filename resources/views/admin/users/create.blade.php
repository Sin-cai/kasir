            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="name" placeholder="Enter name" type="text"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">User Name</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="username" placeholder="Enter User Name" type="text"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Email</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="email" placeholder="Enter Email" type="text"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Password</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="password" placeholder="Enter Password" type="password"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Address</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="alamat" placeholder="Enter Address" type="text"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Phone Number</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="hp" placeholder="Enter Phone Number" type="text"/>
                    </div>
                    <div class="mb-4">
                        <label for="id_kategoris" class="block text-gray-700">Role</label>
                        <select  name="role" class="border border-gray-300 rounded px-4 py-2 w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="status" placeholder="Enter Status" type="text"/>
                    </div>
