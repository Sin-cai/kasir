...
<head>
    ...
    <title>Cashier Dashboard - Users</title>
        ...
        <div class="flex-1 p-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <div class="flex justify-between items-center mb-4">
                    <input class="border border-gray-300 rounded px-4 py-2 w-1/3" placeholder="Search a user" type="text"/>
