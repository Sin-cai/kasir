            ...
            <div class="bg-white p-6 rounded-lg shadow">
                  <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" value="{{ $pelanggan->nama }}"  type="text" name="nama" placeholder="Enter member name"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Address</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" value="{{ $pelanggan->alamat }}" type="text" name="alamat"  placeholder="Enter address"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Phone</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" value="{{ $pelanggan->hp }}" type="number" name="hp" placeholder="Enter phone number" />
                    </div>
