            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <form action="{{ route('produk.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="nama_produk" placeholder="Enter product name" type="text"/>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="harga_beli" placeholder="Enter price" type="number"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Selling price</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="harga_jual" placeholder="Enter price" type="number"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Stock</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="stok" placeholder="Enter stock quantity" type="number"/>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Barcode</label>
                        <input class="border border-gray-300 rounded px-4 py-2 w-full" name="barcode" placeholder="Enter stock quantity" type="number"/>
                    </div>
